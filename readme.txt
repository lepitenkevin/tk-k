...
= 1.0.17 - 2026-09-14 =
* Security: Validate the stored Template Kit folder before removing it, so kit deletion can only ever affect the kit's own folder
* Security: Restrict Template Kit records and their metadata to administrators
* Fix: Deleting a Template Kit now reports an error instead of silently succeeding when the kit cannot be found
