...
class Template_Kits extends Base {
	...
	public function delete_template_kit( $template_kit_id ) {
		...
		// Returns false when the ID is not one of our Template Kit posts.
		return \Envato_Template_Kit_Import\Delete::get_instance()->delete_template_kit( $template_kit_id );
	}
